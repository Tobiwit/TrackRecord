...
export function buildSeedDB(): DB {
  return {
    ...
    posts: [
      ...
      post({ id: "po_j1", ownerUserId: "u_june", personIds: ["p_theo"], eventType: "first_date", title: "Wine, and his ex's name.", text: "He talked about his ex for forty minutes but the wine was good.", moodIcon: "sprout", song: song(2), createdAt: now - 58 * DAY }),
      post({ id: "po_j2", ownerUserId: "u_june", personIds: ["p_theo"], eventType: "mixed_signals", title: "Likes every story, answers nothing.", text: "Likes every story. Answers none of the texts.", moodIcon: "moon", song: song(14), createdAt: now - 45 * DAY }),
      post({ id: "po_j3", ownerUserId: "u_june", personIds: ["p_dex"], eventType: "situationship", title: "Labels are a construct, apparently.", text: "He said 'labels are a construct' and I said 'so is rent' and honestly? We laughed.", moodIcon: "moon", song: song(8), createdAt: now - 32 * DAY }),
      ...
      post({ id: "po_j5", ownerUserId: "u_june", personIds: ["p_dex"], eventType: "sleepover", title: "One (1) egg.", text: "He made breakfast. It was one (1) egg. I'm choosing to see the effort.", moodIcon: "sun", song: song(26), createdAt: now - 9 * DAY }),
      ...
      post({ id: "po_m1", ownerUserId: "u_margot", personIds: ["p_sam"], eventType: "first_date", title: "We closed the wine bar down.", text: "We closed the wine bar down. The waiter gave us free dessert because we 'looked like a movie.'", moodIcon: "rose", song: song(9), createdAt: now - 55 * DAY }),
      post({ id: "po_m2", ownerUserId: "u_margot", personIds: ["p_sam"], eventType: "we_clicked", title: "He remembered the dog.", text: "He remembered the name of my childhood dog. From a story I told once. In passing.", moodIcon: "star", song: song(10), createdAt: now - 48 * DAY }),
      post({ id: "po_m3", ownerUserId: "u_margot", personIds: ["p_sam"], eventType: "first_kiss", title: "Under the flower stand.", text: "Under the awning of the flower stand, obviously. The universe has a sense of set design.", moodIcon: "rose", song: song(0), createdAt: now - 41 * DAY }),
      post({ id: "po_m4", ownerUserId: "u_margot", personIds: ["p_sam"], eventType: "met_friends", title: "The group chat has voted.", text: "He brought a bottle of wine AND flowers for the host. The group chat has voted. It's unanimous.", moodIcon: "sun", song: song(21), createdAt: now - 20 * DAY }),
      post({ id: "po_m5", ownerUserId: "u_margot", personIds: ["p_sam"], title: "He planted herbs on my balcony.", text: "Basil, rosemary, thyme. He said 'for when I cook for you' â€” plural. Future tense. I had to sit down.", moodIcon: "sprout", song: song(22), createdAt: now - 1 * DAY }),

      // ---- Carmen: the dramatic ending ----
      post({ id: "po_c1", ownerUserId: "u_carmen", personIds: ["p_julian"], eventType: "we_clicked", title: "Four hours on a rooftop.", text: "Four hours on a rooftop. He quoted my favorite film unprompted. I should have known it was foreshadowing.", moodIcon: "star", song: song(4), createdAt: now - 110 * DAY }),
      post({ id: "po_c2", ownerUserId: "u_carmen", personIds: ["p_julian"], eventType: "soft_launch", title: "His hand. My candle.", text: "His hand. My candle. One story, 24 hours. The people noticed.", moodIcon: "eye", song: song(28), createdAt: now - 90 * DAY }),
      post({ id: "po_c3", ownerUserId: "u_carmen", personIds: ["p_julian"], eventType: "red_flag", title: "He said 'my Yoko.'", text: "He referred to his ex as 'my Yoko.' I laughed then. I am not laughing now.", moodIcon: "flag", song: song(23), createdAt: now - 60 * DAY }),
      post({ id: "po_c4", ownerUserId: "u_carmen", personIds: ["p_julian"], eventType: "the_talk", title: "'A vibe.' A VIBE.", text: "I asked what we were. He said 'a vibe.' A VIBE. I have named playlists with more commitment.", moodIcon: "flame", song: song(24), createdAt: now - 30 * DAY }),
      post({ id: "po_c5", ownerUserId: "u_carmen", personIds: ["p_julian"], eventType: "it_ended", title: "On a Tuesday. In the rain.", text: "On a Tuesday. In the rain. He kept my tote bag and I kept my dignity, which feels like an uneven trade.", moodIcon: "brokenheart", song: song(15), createdAt: now - 12 * DAY }),
      post({ id: "po_c6", ownerUserId: "u_carmen", personIds: ["p_julian"], eventType: "no_contact", title: "Day 11 of thriving.", text: "Day 11. He viewed my story from a burner account named after his dog. I am thriving. This is what thriving looks like.", moodIcon: "key", song: song(19), createdAt: now - 10 * HOUR }),

      // ---- Test user: partially filled ----
      post({ id: "po_t1", ownerUserId: "u_test", personIds: ["p_alex"], eventType: "first_date", title: "Suspiciously easy.", text: "Coffee turned into a walk turned into dinner. Suspiciously easy.", moodIcon: "sprout", song: song(13), createdAt: now - 15 * DAY }),
